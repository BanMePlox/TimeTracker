    ...
    <aside class="w-64 bg-gray-900 dark:bg-slate-950 text-white flex flex-col min-h-screen">
        ...
        <nav class="flex-1 p-4 space-y-1">
            ...
            <a href="{{ route('admin.ausencias.index') }}"
               class="flex items-center px-4 py-3 rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white transition-colors {{ request()->routeIs('admin.ausencias.*') ? 'bg-blue-600 text-white' : '' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
